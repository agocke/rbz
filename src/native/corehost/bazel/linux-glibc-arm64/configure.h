...
// Hardcoded for linux-glibc-arm64 (Bazel build).
...
#define HOST_POLICY_PKG_NAME "runtime.linux-arm64.Microsoft.NETCore.DotNetHostPolicy"
#define HOST_POLICY_PKG_REL_DIR "runtime.linux-arm64/native"
