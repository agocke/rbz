...
/* #undef HAVE_UNW_AARCH64_X19 */
#define HAVE_PUBLIC_XSTATE_STRUCT 1
#define HAVE__FPX_SW_BYTES_WITH_XSTATE_BV 1
...
#define HAVE_FPSTATE_GLIBC_RESERVED1 1
...
// On Linux ARM64, libunwind uses a custom unw_tdep_context_t (not ucontext_t)
...
#define HAVE_PROCFS_CTL 1
#define HAVE_PROCFS_STAT 1
...
#define PAL_PTRACE(cmd, pid, addr, data) ptrace((enum __ptrace_request)(cmd), (pid), (caddr_t)(addr), (data))
